...
public class HuffmanTree {
	...
	public HuffmanTree(byte[] bytes, boolean useNumbers) {
		this.useNumbers = useNumbers;
		createTree(generateFrequencies(bytes));
	}
	
	public HuffmanTree(PriorityQueue<FrequencyData> data, boolean useNumbers) {
		this.useNumbers = useNumbers;
		createTree(data);
	}
	
	private PriorityQueue<FrequencyData> generateFrequencies(byte[] bytes) {
		FrequencyData frequency;
		PriorityQueue<FrequencyData> frequencies = new PriorityQueue<FrequencyData>();
	...
	private void createTree(PriorityQueue<FrequencyData> frequencies) {
